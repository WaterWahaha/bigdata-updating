        ...
        <div class="div_any">
            <div class="left div_left_any02">
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../static/images/title_1.png">省各部门诉求办理情况汇总报表  &nbsp;&nbsp;总办结量：{{zbjl}} 平均报结件数：{{pjbjjs}}
                      <button type="button" name="button" class="downexcel" @click="exportExcel" style="display:inline">下载</button>
                    </div>
