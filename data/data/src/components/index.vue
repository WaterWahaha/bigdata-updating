  ...
  <div class="container">
    ...
    <div class="con left">
        ...
        <div class="con_div">
          <div class="con_div_text">
            ...
            <div class="table" style="z-index:999;background-color:#030829;position:absolute;margin-left:200px;margin-top;-80px;width:1500px;display:none">
              ...
              <button type="button" name="button" class="downexcel_11" @click="returnTo_table" >返回</button>
        ...
        <div class="div_any">
            ...
            <div class="div_any02 left ">
                <div class="div_any_child div_height">
                    <div class="div_any_title any_title_width"><img src="../../static/images/title_1.png">年诉求变化分析 </div>
                    <div id="Chart05" style="width:97.5%;height:95%;display: inline-block;padding-left: 1.25%;padding-top:2.2%"></div>
                </div>
            </div>
            <div class="right div_any01">
                <div class="div_any_child">
                    <div class="div_any_title"><img src="../../static/images/title_1.png">本年度重点数据一览</div>
...
export default {
  ...
  methods:{
    ...
    table10(e){
      ...
      this.get(host.url+'/ajpxtabletwo',{start:this.start,end:this.end,sldw:e.target.dataset.name,flag:this.ajType}).then((res)=>{
        $(".downexcel_11").show();
        $(".downexcel_01").show();
        //console.log('yta',res)
        this.loading();
    ...
    returnTo_table(e){
      if(this.type_table == 1){
        ...
        this.get(host.url+'/ajpxtabletwo',{start:this.start,end:this.end,sldw:this.sldw,flag:this.ajType}).then((res)=>{
          $(".downexcel_11").show();
          $(".downexcel_01").show();
          //console.log('yta',res)
          this.loading();
